...
#else
	// tracking pyramid levels.
    #define MAPPING_THREADS 8 // Default: 4
	#define RELOCALIZE_THREADS 8 // Default: 6
#endif
...
extern bool sparseTracking;
extern float pixelDensityForTracking;    
    
#define INITIALIZATION_PHASE_COUNT 5
extern int initializationPhaseCount;

#define MIN_NUM_MAPPED 5 // Default: 5
