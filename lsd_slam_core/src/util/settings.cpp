...
bool sparseTracking = false;
float pixelDensityForTracking = 1.0f; // Default 1.0 (100% full pixels)),
                                      //         0.1 (10% pixels from total)
int initializationPhaseCount = INITIALIZATION_PHASE_COUNT; // Default 5
