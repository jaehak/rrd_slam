...
public:
    ...
    virtual void trackFrame(uchar* image, unsigned int frameID,
    ...
    virtual bool doMappingIteration();
    ...
    std::vector<Frame*> getKeyframesAll();
...
public: void set_depthMapScreenshotFlag(bool val)
    {
        depthMapScreenshotFlag = val;
    }
