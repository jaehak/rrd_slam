...
public:
    ...
    // Debug info
    float debugInfo_lastResidual;
    float debugInfo_pointUsage;
    float debugInfo_usageCount;
    float debugInfo_permaRefNumPts;
    float debugInfo_numData;
    float debugInfo_initialTrackedResidual;
...
protected:
    ...
    virtual float calcResidualAndBuffers(
